...
public class Vstmt extends SemanticAction {
	...
	// 声明语句=类型,声明元@main.syntax.action.Vstmt.a1
	...
	// 声明语句=声明语句,com,声明元@main.syntax.action.Vstmt.a2
	...
	// 类型=int@main.syntax.action.Vstmt.a3
	// 类型=bool@main.syntax.action.Vstmt.a3
	// 类型=char@main.syntax.action.Vstmt.a3
	// 类型=real@main.syntax.action.Vstmt.a3
	public void a3(V left, V[] right){
		left.attr("type", right[0].attr("value"));
	}
	// 声明元=id@main.syntax.action.Vstmt.a4
	...
	// 声明元=声明元数组参数表,]@main.syntax.action.Vstmt.a5
	public void a5(V left, V[] right){
		Symbol s = (Symbol)right[0].attr("symbol");
		left.attr("symbol", s);
	}
	// 数组参数表=id,[,值@main.syntax.action.Vstmt.a6
	...
	// 数组参数表=数组参数表,com,值@main.syntax.action.Vstmt.a7
