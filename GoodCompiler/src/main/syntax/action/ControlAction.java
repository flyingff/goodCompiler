...
public class ControlAction extends SemanticAction {
	...
	// 执行语句=控制语句@main.syntax.action.ControlAction.pass
	// 控制语句=if语句@main.syntax.action.ControlAction.pass
	// 控制语句=while语句@main.syntax.action.ControlAction.pass
	public void pass(V left, V[] right) {
		left.attr("chain", right[0].attr("chain"));
	}
	// 执行语句组 = 执行语句组,执行语句@main.syntax.action.ControlAction.c1
	...
	// 执行语句组=执行语句@main.syntax.action.ControlAction.c11
	...
	// if语句=没有else的if语句,else子句@main.syntax.action.ControlAction.c7
	...
	// if语句=没有else的if语句@main.syntax.action.ControlAction.c9
