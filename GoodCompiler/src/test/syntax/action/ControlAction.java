...
public class ControlAction extends SemanticAction {
	...
	// 执行语句=控制语句@test.syntax.action.ControlAction.pass
	// 控制语句=if语句@test.syntax.action.ControlAction.pass
	// 控制语句=while语句@test.syntax.action.ControlAction.pass
	public void pass(V left, V[] right) {
		left.attr("chain", right[0].attr("chain"));
	}
	// 执行语句组 = 执行语句组,执行语句@test.syntax.action.ControlAction.c1
